...
np.savetxt('Model_3_X_test.csv',x_test,delimiter =",")
np.savetxt('Model_3_Y_test.csv',y_test,delimiter =",")
...
history = model.fit(train_LSTM_X, train_LSTM_y, epochs=50, batch_size=72, validation_data=(val_LSTM_X, val_LSTM_y), verbose=2, shuffle=False)

# save model and architecture to single file
model.save('Save_Model3.h5')
...
# load model
model = load_model('Save_Model3.h5')
...
pickle.dump(model1, open('Model_3.pkl', 'wb'))
